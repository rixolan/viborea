...
Nunca el WhatsApp de producción de la academia (KAPSO). Sin keys en git. `template` en el dominio es la planilla madre (`templates`); acá se dice **WhatsApp message template**.

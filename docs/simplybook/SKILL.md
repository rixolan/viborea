...
Catálogo de escenarios, UI y API: [MIGRACION.md](./MIGRACION.md) §9. Providers y sedes: §1.2. No copies esas tablas acá.

## Load

1. [AGENTS.md](../../AGENTS.md). Copy al alumno: nunca “Viborea”, nunca `viborea.com` ni `/reservar`. WhatsApp solo `+595971638427`.
2. [CONTEXT.md](../../CONTEXT.md): `Absence`, `Series`. Ausencia no pisa el horario semanal.

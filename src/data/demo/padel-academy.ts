...
export const DEMO_LOCATIONS: DemoLocation[] = [
  {
    ...
    studio_id: DEMO_STUDIO.id,
    name: "Costanera",
    address_line1: "Av. Costanera 1200",
    address_line2: null,
    city: "Asunción",
    state: "Central",
    postal_code: "1209",
  ...
  },
  {
    ...
    studio_id: DEMO_STUDIO.id,
    name: "Parque",
    address_line1: "Ruta Mcal. Estigarribia 450",
    address_line2: null,
    city: "Asunción",
    state: "Central",
    postal_code: "1749",
...
export const DEMO_TEACHERS: DemoStaff[] = [
  {
    profile: staffProfile(
      ...
      "Lucía",
      "Benítez",
      "lucia@alameda.example",
      "Entrenadora. Individual y dual.",
    ),
    role: "teacher",
    ...
    pay_rate_cents: 0,
    pay_type: "hourly",
    bio: "Entrenadora. Individual y dual.",
  },
  {
    profile: staffProfile(
      "teacher-marcos",
      "Marcos",
      "Villalba",
      "marcos@alameda.example",
      "Entrenador. Dual y grupal.",
    ),
    role: "teacher",
  ...
  },
  {
    profile: staffProfile(
      ...
      "Sofía",
      "Rivas",
      "sofia@alameda.example",
      "Entrenadora. Grupal y técnica.",
    ),
    role: "teacher",
    ...
    pay_rate_cents: 0,
    pay_type: "hourly",
    bio: "Entrenadora. Grupal y técnica.",
  },
];
